...
<head>
<meta charset="utf-8">
<title>Counsel Law HTML-5 Template | Services</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
					...
					<nav class="main-menu navbar-expand-md">
						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
								...
								<li class="dropdown current"><a href="#">Our Services</a>
									<ul>
    ...
    <section class="page-title" style="background-image:url(images/background/1.jpg)">
    	<div class="auto-container">
			<h1>Services Style 02</h1>
			<ul class="page-breadcrumb">
				<li><a href="index.html">home</a></li>
				<li>Services Style 02</li>
			</ul>
        </div>
    </section>
    <!-- End Page Title -->
			...
			<div class="services-block-three">
				<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
					<div class="row clearfix">
						...
						<div class="content-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<h2><a href="corporate_law.html">Corporate Law</a></h2>
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<div class="image">
									<a href="corporate_law.html"><img src="images/resource/service-2.jpg" alt=""></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
					<div class="row clearfix">
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<div class="image">
									<a href="corporate_law.html"><img src="images/resource/service-3.jpg" alt=""></a>
								</div>
							</div>
						</div>
						<!-- Content Column -->
						<div class="content-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<h2><a href="corporate_law.html">Real Estate Law</a></h2>
								<div class="text">Temporibus autem quibusdam et aut officiis debitiaut rerum necessitatibus saepe eveniet ut et volutares repudiandae molestiae non earum rerum aic tenetur a sapiente delectus.</div>
								<a href="contact.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
							</div>
						</div>
			...
			<div class="services-block-three">
				<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
					<div class="row clearfix">
						...
						<div class="content-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<h2><a href="corporate_law.html">Insurance Law</a></h2>
								<div class="text">Temporibus autem quibusdam et aut officiis debitiaut rerum necessitatibus saepe eveniet ut et volutares repudiandae molestiae non earum rerum aic tenetur a sapiente delectus.</div>
								<a href="contact.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
							</div>
						</div>
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<div class="image">
									<a href="corporate_law.html"><img src="images/resource/service-4.jpg" alt=""></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
					<div class="row clearfix">
						...
						<div class="image-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<div class="image">
									<a href="corporate_law.html"><img src="images/resource/service-5.jpg" alt=""></a>
								</div>
							</div>
						</div>
						<!-- Content Column -->
						<div class="content-column col-lg-6 col-md-12 col-sm-12">
							<div class="inner-column">
								<h2><a href="corporate_law.html">Family Law</a></h2>
								<div class="text">Temporibus autem quibusdam et aut officiis debitiaut rerum necessitatibus saepe eveniet ut et volutares repudiandae molestiae non earum rerum aic tenetur a sapiente delectus.</div>
								<a href="contact.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
							</div>
						</div>
