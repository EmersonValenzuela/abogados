...
<head>
<meta charset="utf-8">
<title>Counsel Law HTML-5 Template | About Us</title>
<!-- Stylesheets -->
        	...
        	<div class="auto-container clearfix">
				...
				<div class="nav-outer clearfix">
						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
								<li class="dropdown"><a href="#">Inicio</a>
									<ul>
										<li><a href="index.html">Estilo uno</a></li>
                                        <li><a href="index-2.html">Estilo dos</a></li>
								    </ul>
								</li>
								<li class="current dropdown"><a href="#">Acerca de</a>
									<ul>
										<li><a href="about.html">Sobre Nosotros</a></li>
                                        <li><a href="our_team.html">Nuestro Equipo</a></li>
								    </ul>
								</li>
                                <li class="dropdown"><a href="#">Casos</a>
                                	<ul>
								...
								<li class="dropdown"><a href="#">Nuestro Servicios</a>
									<ul>
					...
					<div class="outer-box clearfix">
						...
						<!-- Btn Box -->
						<div class="btn-box">
							<a href="contact.html" class="theme-btn btn-style-one"><span class="txt">Contáctenos</span></a>
						</div>
            ...
            <div class="auto-container clearfix">
                ...
                <div class="pull-right">
					...
					<div class="outer-box clearfix">
						...
						<!-- Btn Box -->
						<div class="btn-box">
							<a href="contact.html" class="theme-btn btn-style-two"><span class="txt">Contáctenos</span></a>
						</div>
			...
			<div class="row clearfix">
				...
				<div class="services-block-two col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5><a href="corporate_law.html">Servios Legales</a></h5>
						<div class="text"></div>
				...
				<div class="services-block-two col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5><a href="corporate_law.html">Buenos Resultados</a></h5>
				...
				<div class="services-block-two col-lg-4 col-md-6 col-sm-12">
					<div class="inner-box wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
						...
						<h5><a href="corporate_law.html">Personas Apacionadas</a></h5>
						<div class="text">Quis autem velo eum iure rerehen derit rui inea votasuam nihil molestia conseuatur vel illum</div>
						<a class="arrow flaticon-right-arrow-3" href="corporate_law.html"></a>
					</div>
				</div>
    ...
    <section class="fluid-section-two">
    	...
    	<div class="outer-container clearfix">
            ...
            <div class="image-column" style="background-image:url(images/resource/image-2.jpg)">
				<a href="../watch.html?v=kxPCFljwJws" class="lightbox-image video-box"><span class="fa fa-play"><i class="ripple"></i></span></a>
