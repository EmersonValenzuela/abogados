...
<head>
<meta charset="utf-8">
<title>Counsel Law HTML-5 Template | Case studies</title>
<!-- Stylesheets -->
					...
					<nav class="main-menu navbar-expand-md">
						...
						<div class="navbar-collapse collapse clearfix" id="navbarSupportedContent">
							<ul class="navigation clearfix">
                                ...
                                <li class="dropdown current"><a href="#">Cases</a>
                                	<ul>
			...
			<div class="inner-container">
				<div class="row clearfix">
					...
					<div class="case-block col-lg-6 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								...
								<a href="case-details.html"><img src="images/resource/case-2.jpg" alt=""></a>
							</div>
							<div class="lower-content">
								<h3><a href="case-details.html">Quis autem vel eum iure reaeenderit reby.</a></h3>
								<a href="case-details.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
							</div>
						</div>
					</div>
					...
					<div class="case-block col-lg-6 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								...
								<a href="case-details.html"><img src="images/resource/case-3.jpg" alt=""></a>
							</div>
							<div class="lower-content">
								<h3><a href="case-details.html">nostrum exercitationem ullam corporis.</a></h3>
								<a href="case-details.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
							</div>
						</div>
					</div>
					...
					<div class="case-block col-lg-6 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<div class="tag">injury</div>
								<a href="case-details.html"><img src="images/resource/case-4.jpg" alt=""></a>
							</div>
							<div class="lower-content">
								<h3><a href="case-details.html">officiis debitis aut rerum necessitatibus.</a></h3>
								<a href="case-details.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
							</div>
						</div>
					</div>
					...
					<div class="case-block col-lg-6 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<div class="tag">Accident</div>
								<a href="case-details.html"><img src="images/resource/case-6.jpg" alt=""></a>
							</div>
							<div class="lower-content">
								<h3><a href="case-details.html">praesentium voluptatum deleniti atque.</a></h3>
								<a href="case-details.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
							</div>
						</div>
					</div>
					...
					<div class="case-block col-lg-6 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								<div class="tag">Insurance</div>
								<a href="case-details.html"><img src="images/resource/case-5.jpg" alt=""></a>
							</div>
							<div class="lower-content">
								<h3><a href="case-details.html">officiis debitis aut rerum necessitatibus.</a></h3>
								<a href="case-details.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
					...
					<div class="case-block col-lg-6 col-md-6 col-sm-12">
						<div class="inner-box">
							<div class="image">
								...
								<a href="case-details.html"><img src="images/resource/case-7.jpg" alt=""></a>
							</div>
							<div class="lower-content">
								<h3><a href="case-details.html">praesentium voluptatum deleniti atque.</a></h3>
								<a href="case-details.html" class="theme-btn btn-style-three"><span class="txt">Read more <i class="arrow flaticon-right"></i></span></a>
